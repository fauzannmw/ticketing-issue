...
export const TicketProgresModal: React.FC<ModalUiProps> = ({ ticketId }) => {
  ...
  return (
    <>
      <button
        onClick={onOpen}
        className="w-full flex justify-center items-center p-0.5 border-1 border-black rounded-md text-sm hover:scale-105 duration-250"
      >
        Detail
      </button>
      <Modal
